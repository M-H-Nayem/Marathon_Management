...
const Footer = () => {
  return (
    <footer className="py-6 bg-gray-800 text-white">
      <div className="container p-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
        <div>
          <div className="pb-6 text-center">
            ...
            <p className="text-xl pt-3">Location - Savar,Dhaka</p>
          </div>
        </div>
